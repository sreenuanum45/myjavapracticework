...
public class Flipkart_4 {
	...
	public static void main(String[] args) throws Exception {
		...
		driver.manage().window().maximize();
		  ...
		  try {
		  driver.findElement(By.xpath("//span[text()='Login']/preceding::button[1]")).
		  click();
		  Thread.sleep(2000);
		  }catch (Exception e) {
		...
		WebElement shadowRoot = (WebElement) ((JavascriptExecutor)driver).executeScript("return arguments[0].shadowRoot", shadowroothostelement);
		// Switch to the iframe
		driver.switchTo().frame(3);
		WebElement elementToPressAndHold = shadowRoot.findElement(By.xpath("(//div[@role='button']")); // Replace with your target element
