...
public class Webtable2 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//Launch site
		driver.get("https://www.espncricinfo.com/series/india-in-west-indies-2023-1381201/west-indies-vs-india-1st-test-1381212/full-scorecard");
		Thread.sleep(5000); 
...
//create an object to utility class
    ...
    for(int i=1;i<=rows-4;i++)
    {
    	try {
    		...
    		System.out.println(name+"   "+desc+"   "+a+"   "+b+"   "+c+"   "+d+"   "+e+"   "+f);
