...
public class Mytest11 {
	...
	public static void main(String[] args) throws Exception {
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath("//input[@type='file']")).sendKeys("C:\\Users\\sreenu\\OneDrive\\Pictures\\Screenshots\\Screenshot 2023-05-25 084228.png");
		Thread.sleep(3000);
		driver.findElement(By.xpath("//button[@title='Send this email']")).click();
		Thread.sleep(3000);
		String x= driver.
				        findElement(By.xpath("//div[@role='presentation']/following-sibling::div[1]")).getText();
