...
public class Iframetest3 {
	...
	//	driver.findElement(By.xpath("//a[normalize-space()='Beginners Guide'])/parent::span[1]")).click();
		//driver.findElement(By.xpath("(//a[normalize-space()='Beginners Guide'])//following::*[1]")).click();
		Thread.sleep(12000);
		//driver.findElement(By.xpath("//a[text()='Beginners Guide']")).click();
		//driver.findElement(By.xpath("//a[normalize-space()='Beginners Guide']")).click();
		Thread.sleep(4000);
