...
public class Yahoo_1 {
	...
	public static void main(String[] args) throws Exception {
		...
		driver.findElement(By.xpath("//input[@type='file']")).sendKeys("C:\\Users\\sreenu\\OneDrive\\Pictures\\Screenshot 2023-02-13 193110.png");
		Thread.sleep(10000);
		...
		//switch to that new window
				...
				driver.findElement(By.name("password")).sendKeys("Veeru80@"
				  ...
				  Thread.sleep(5000);
				  String a=driver.findElement(By.xpath("//ul[contains(@class,'v-Mailbox')]/li[1]/a/div//span//span[@title='sreenuanumandla@yahoo.com']"))
				  .getAttribute("title");	
				  ...
				  String b=driver.findElement(By.xpath("//ul[contains(@class,'v-Mailbox')]/li[1]/a/div[4]")).getAttribute("title");
				  ...
				  //logout
				  driver.findElement(By.xpath("//div[contains(@class,'v-MainNavToolbar-userName u-hideifempty u-trim u-overflow-padtrim ')]")).click();
