...
public class Flipkart2 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(5000);
		List<WebElement>al2=driver.findElements(By.xpath("//div[text()='Newest First']/following::div[@class='CXW8mj']"));
		for(int i=0;i<al2.size();i++) {
			...
			String sreenu=driver.findElement(By.xpath("//div[@id='price-info-icon']/preceding::div[@class='_30jeq3 _16Jk6d']"))
					.getText();
			Thread.sleep(5000);
