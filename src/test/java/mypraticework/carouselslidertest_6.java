...
public class carouselslidertest_6 {
	...
	public static void main(String[] args) throws Throwable {
		...
		String currentSlideIndexAttribute1=currentsliderelement1.findElement(By.xpath("descendant::img")).getAttribute("src");
		Thread.sleep(3000);
		WebElement currentsliderelement2=slider.findElement(By.xpath("(//div[contains(@class,'slick-current')])[1]"));
	       
		String currentSlideIndexAttribute2=currentsliderelement2.findElement(By.xpath("descendant::img")).getAttribute("src");
		if(!currentSlideIndexAttribute1.equals(currentSlideIndexAttribute2)) {
			...
			String parentLeftValue=(String)driver.executeScript(
			         "return(window.getComputedStyle(arguments[0].parentNode).getPropertyValue('left'));", currentsliderelement1 );
